...
Plug 'https://github.com/gcorne/phpfolding.vim.git'
...
Plug 'https://github.com/joonty/vim-do.git'
Plug 'https://github.com/dhruvasagar/vim-dotoo.git'
...
Plug 'https://github.com/JarrodCTaylor/vim-shell-executor.git'
Plug 'https://github.com/Shougo/vimshell.vim.git'
Plug 'https://github.com/tpope/vim-speeddating.git'
Plug 'https://github.com/idbrii/AsyncCommand'
...
Plug 'https://github.com/idanarye/vim-terminalogy.git'
Plug 'https://github.com/myusuf3/numbers.vim.git'
Plug 'https://github.com/kamwitsta/mythos.git'
